				...
				<div className="">
					...
					<div className="flex flex-row">
						<div className="border p-16 max-w-sm [&_select]:w-full [&_select]:rounded-sm [&_select:focus]:border-primary [&_select:focus]:shadow-sm [&_select:focus]:shadow-primary-light">
							<div>
								<h1 className="text-4xl text-primary font-bold my-4">Price</h1>
							...
							<div>
								<h1 className="text-4xl text-primary font-bold my-4">Model</h1>
							...
							<div>
								<h1 className="text-4xl text-primary font-bold my-4">Engine</h1>
								<select className="form-select my-4" name="price" id="price">
